(function() {
  function init() {
    ...
    container.innerHTML = '<svg viewBox="0 0 400 240" xmlns="http://www.w3.org/2000/svg">' +
      '<defs>' +
      '<linearGradient id="hg1" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#06d6a0" stop-opacity="0.7"/><stop offset="100%" stop-color="#7b61ff" stop-opacity="0.7"/></linearGradient>' +
      '<linearGradient id="hg2" x1="0%" y1="0%" x2="100%" y2="100%"><stop offset="0%" stop-color="#7b61ff" stop-opacity="0.6"/><stop offset="100%" stop-color="#ff6b9d" stop-opacity="0.6"/></linearGradient>' +
      ...
      '<circle r="4" fill="#06d6a0" filter="url(#glow)"><animateMotion dur="2.5s" repeatCount="indefinite" path="M130,120 Q200,80 270,95"/></circle>' +
      '<circle r="3" fill="#7b61ff" filter="url(#glow)"><animateMotion dur="3s" repeatCount="indefinite" path="M130,120 Q200,140 270,95"/></circle>' +
      '<circle r="3" fill="#ff6b9d" filter="url(#glow)"><animateMotion dur="2s" repeatCount="indefinite" path="M130,120 Q200,100 270,95"/></circle>' +
      '</svg>';
  }
